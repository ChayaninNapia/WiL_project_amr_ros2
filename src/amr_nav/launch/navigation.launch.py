...
def generate_launch_description():
    ...
    my_nav_pkg_dir = get_package_share_directory('amr_nav')
    
    # กำหนดตำแหน่งไฟล์ configuration ต่างๆ
    rviz_config_file = os.path.join(my_nav_pkg_dir, 'rviz', 'navigation.rviz')
    map_yaml_file = os.path.join(my_nav_pkg_dir, 'maps', 'lertvilai01.yaml')
    params_file = os.path.join(my_nav_pkg_dir, 'config', 'basic_params.yaml')
